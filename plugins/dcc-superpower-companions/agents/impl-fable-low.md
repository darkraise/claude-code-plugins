---
name: impl-fable-low
description: "Task implementer running Fable 5 at low effort. Dispatched by dcc-superpower-companions for escalation only, reached from impl-opus-low."
model: fable
effort: low
skills:
...
You run on Fable 5 at low effort.
