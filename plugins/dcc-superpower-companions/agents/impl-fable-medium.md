...
description: "Task implementer running Fable 5 at medium effort. Dispatched by dcc-superpower-companions for escalation only, reached from impl-opus-medium."
model: fable
effort: medium
skills:
...
You run on Fable 5 at medium effort.
