...
description: "Task implementer running Sonnet 5 at xhigh effort. Dispatched by dcc-superpower-companions for score 4: multi-file work with some of the approach left open."
model: sonnet
effort: xhigh
skills:
...
You run on Sonnet 5 at xhigh effort.
