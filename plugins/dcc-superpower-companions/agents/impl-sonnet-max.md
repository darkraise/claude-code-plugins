...
description: "Task implementer running Sonnet 5 at max effort. Dispatched by dcc-superpower-companions for score 5: intricate work at the top of the Sonnet range."
model: sonnet
effort: max
skills:
...
You run on Sonnet 5 at max effort.
