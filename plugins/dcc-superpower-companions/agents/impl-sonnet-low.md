...
description: "Task implementer running Sonnet 5 at low effort. Dispatched by dcc-superpower-companions for score 1: two or three files with near-complete code supplied."
model: sonnet
effort: low
skills:
